...
export const translations = {
  ar: {
   ...
   // "nav.prizes": "الجوائز",
    ...
    "timeline.phase7Date": "5 فبراير 2026",
  ...
  en: {
   ...
   // "nav.prizes": "Prizes",
    ...
    "timeline.phase7Date": "February 5, 2026",
